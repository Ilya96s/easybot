 ...
 */
@Schema(description = "Модель данных, описывающая монитор")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class MonitorDTO {
    ...
    @Min(value = 21, message = "Minimum diagonal should be 21")
    @Max(value = 50, message = "Maximum diagonal should be 50")
